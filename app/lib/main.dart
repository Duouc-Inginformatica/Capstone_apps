      ...
      onGenerateRoute: (settings) {
        switch (settings.name) {
          ...
          case BusStatusReportScreen.routeName:
            return MaterialPageRoute(builder: (_) => const BusStatusReportScreen());
          case RouteIssueReportScreen.routeName:
            return MaterialPageRoute(builder: (_) => const RouteIssueReportScreen());
          case StopInfoReportScreen.routeName:
            return MaterialPageRoute(builder: (_) => const StopInfoReportScreen());
          case GeneralSuggestionScreen.routeName:
            return MaterialPageRoute(builder: (_) => const GeneralSuggestionScreen());
          default:
            return MaterialPageRoute(builder: (_) => const LoginScreen());
        }
      },
