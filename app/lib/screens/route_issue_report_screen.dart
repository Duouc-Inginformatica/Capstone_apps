...
class RouteIssueReportScreen extends StatefulWidget {
  const RouteIssueReportScreen({super.key});
  static const routeName = '/contribute/route-issue';

  @override
  State<RouteIssueReportScreen> createState() => _RouteIssueReportScreenState();
}
...
class _RouteIssueReportScreenState extends State<RouteIssueReportScreen> {
  ...
  final Map<String, String> _issues = {
    'detour': 'Ruta desviada',
    'suspended': 'Ruta suspendida',
    'schedule_change': 'Horarios cambiados',
    'blocked': 'Ruta bloqueada',
  };
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        'Selecciona el problema con la ruta',
                        style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.w600,
                          color: Colors.black,
