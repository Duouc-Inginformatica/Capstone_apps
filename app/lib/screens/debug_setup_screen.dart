...
// 🔧 FLAG GLOBAL DE DEBUG - Controla TODOS los logs de la aplicación
bool debug = true;
...
class _DebugSetupScreenState extends State<DebugSetupScreen> {
  ...
  Widget _buildDebugToggleCard(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
