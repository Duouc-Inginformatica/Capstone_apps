...
class GeneralSuggestionScreen extends StatefulWidget {
  const GeneralSuggestionScreen({super.key});
...
class _GeneralSuggestionScreenState extends State<GeneralSuggestionScreen> {
  ...
  final Map<String, String> _suggestionTypes = {
    'app_improvement': 'Mejora de la app',
  ...
  Future<void> _submitSuggestion() async {
    ...
    try {
      final success = await ContributionService.instance.submitContribution(
        ...
        title: _suggestionTypes[_selectedType]!,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        'Selecciona el tipo de sugerencia',
                        style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.w600,
                          color: Colors.black,
                    ...
                    // Lista simple de tipos de sugerencia
                    Expanded(
                      flex: 2,
                    ...
                    // Campo obligatorio para la sugerencia
                    Expanded(
                      flex: 1,
                      child: Container(
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                decoration: const InputDecoration(
                                  hintText: 'Describe tu sugerencia aquí...',
